...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/02 13:35:53 by abchikhi          #+#    #+#             */
/*   Updated: 2024/09/14 23:56:24 by abchikhi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char				*ft_substr(t_db *db, char const *s, unsigned int start,
						size_t len);
...
int					ft_intlen(int n);
char				*allocate_buffer(t_db *db, long long *number, int *len,
						int *neg);
void				fill_string(long long number, int len, int neg,
						char *string);
char				*ft_itoa(t_db *db, int n);
char				*allocate_buffer_ec(t_db *db, long long *number, int *len,
						int *neg);
